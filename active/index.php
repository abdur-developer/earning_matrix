...
// }
    ...
    if (isset($_FILES['img'])) {
        ...
        if(strlen($phone) != 11){
            ...
            //query all data
            $sql = "INSERT INTO active ( user_id, number, amount, method, img ) VALUES ( '$id', '$phone', '100', '$method', '$img' )";
...
<body>
    <section class="mt-4">
        <h1 class='text-primary text-center'>Account Activition</h1>
        <div class="bg-light p-2 rounded">
            <p class="text-black text-center mb-2 small">
                নিচের বিকাশ/নগদ নাম্বারটি কপি করে আপনার বিকাশ/নগদ আপস থেকে উল্লেখিত ফী সেন্ড মানি করুন । আপনার পেমেন্ট এর পরিমাণ <strong class="er">১০০</strong> টাকা
            </p>
            ...
            <div class="text-black text-justify small p-2">
                <p>
                   উপরের বিকাশ/নগদ নাম্বারে উল্লেখিত ফী সেন্ড মানি করার পর নিচের ফ্রম টি পুরন করুন। প্রথমে সিলেক্ট করুন আপনি কোন মাধ্যমে টাকা পাঠিয়েছেন। দ্বিতীয়তে আপনি যে নাম্বার থেকে টাকা পাঠিয়েছেন সেই নাম্বারটি দিন। তারপরে আপনার দেওয়া সেন্ট-মানির স্ক্রিনশর্ট দিন । তারপর <strong>Verify</strong> এ ক্লিক করুন ।
                </p>
            </div>
        </div>
