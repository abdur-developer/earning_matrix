...
<div class="bg-secondary py-2 row">
		...
		<h3 class="text-white text-center col-11">Product Details</h3>
            ...
            <?php foreach($customers as $customer) :  
                ...
                <div class="border rounded border-primary p-1 mb-3">
                    <div class="row bg-white justify-content-center" style="height: 70px;">
                        ...
                        <div class="col-5">
                            <p class="d-inline " style="font-size: 15px; font-weight: 500;"><?= $customer['name']; ?></p>
                            <p class="small"><?= $customer['time']; ?></p>
                        </div>
                        <div class="col-2"><h4 class="fw-bolder text-center pt-3"><?= $customer['current_price']; ?>$</h4></div>
